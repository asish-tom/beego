...
Install:
	...
	go get github.com/asish-tom/beego/v2/core/validation

Test:

	go test github.com/asish-tom/beego/v2/core/validation
...
Direct Use:
	...
	import (
		"github.com/asish-tom/beego/v2/core/validation"
		"log"
	)
